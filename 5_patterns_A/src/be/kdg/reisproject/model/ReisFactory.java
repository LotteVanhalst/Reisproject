...
public class ReisFactory {
    ...
    public static Reis newFilledReis(String naam, Werelddeel werelddeel, String begindatum, int aantalDagen, double kostprijs, String taal, String munteenheid, double gemiddeldeTemp, double zakgeld){
        return new Reis(naam, werelddeel, begindatum, aantalDagen, kostprijs, taal, munteenheid, gemiddeldeTemp, zakgeld);
    }

    public static Reis basisFilledReis(String naam, String begindatum, int aantalDagen, double kostprijs){
    ...
    public static Reis newRandomReis(){
        ...
        LocalDateTime localDateTime = LocalDateTime.now().plusDays(random.nextInt(700));
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
        String begindatum = localDateTime.format(formatter);
